...
let
  ...
  */
  ...
  allAttrs = pred: attrs:
    pkgs.lib.all pred (pkgs.lib.mapAttrsToList (_: value: value) attrs);
  ...
  */
  ...
  anyAttrs = pred: attrs:
    pkgs.lib.any pred (pkgs.lib.mapAttrsToList (_: value: value) attrs);
  ...
  */
  ...
  mapValuesToList = f: attrs: pkgs.lib.mapAttrsToList (_: v: f v) attrs;
