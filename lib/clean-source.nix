...
let
  ...
  cleanSourceNix = src: pkgs.lib.cleanSourceWith { filter = cleanSourceFilterNix; inherit src; };
  ...
  cleanSourceHaskell = src: pkgs.lib.cleanSourceWith { filter = cleanSourceFilterHaskell; inherit src; };
  ...
  cleanSourceSystemCruft = src: pkgs.lib.cleanSourceWith { filter = cleanSourceFilterSystemCruft; inherit src; };
  ...
  cleanSourceEditors = src: pkgs.lib.cleanSourceWith { filter = cleanSourceFilterEditors; inherit src; };
  ...
  cleanSourceMaintainer = src: pkgs.lib.cleanSourceWith { filter = cleanSourceFilterMaintainer; inherit src; };
